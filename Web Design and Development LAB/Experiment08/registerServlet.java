// Change the password with the actual password of yours in the line 29
package com.servlet;
...
@Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/simplelogin", "root", "password");
